...
public class UserController {
	 ...
	 * @Secured({ROLE_ADMIN})
	 * 
	 * @GetMapping public ApiResponse listUser(){
	 * log.info(String.format("received request to list user %s",
	 * authenticationFacadeService.getAuthentication().getPrincipal())); return new
	 * ApiResponse(HttpStatus.OK, SUCCESS, userService.findAll()); }
	 */
	 ...
	 * "id") Long id){ log.info(String.format("received request to delete user %s",
