...
export class ViewEventReportsService {
  ...
  getEventDetailedInfo(eventId: string): Observable<EventDetails> {
    ...
    const r = this.http.get<any>(`${this.endpoint.api.getOutreachEvents}/${eventId}`)
    console.log(r);
    return r;
  }
  ...
  // getUnParticipatedReasons() {
  //   return Observable.of(NOT_PARTICIPATED);
  // }
  // getUnregisteredReasons() {
  //   return Observable.of(UNREGISTERED_REASON);
  // }
  // getParticipatedRatings() {
  //   return Observable.of(PARTICIPATED_RATING);
  // }
